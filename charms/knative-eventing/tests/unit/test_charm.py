...
def test_events(harness, mocked_lightkube_client, mocker):
    ...
    harness.begin()
    install = mocker.patch("charm.KnativeEventingCharm._on_install")
    config_changed = mocker.patch("charm.KnativeEventingCharm._on_config_changed")
    remove = mocker.patch("charm.KnativeEventingCharm._on_remove")
