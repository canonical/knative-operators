...
class GatewayConsumer(Object):
    ...
    def _on_relation_changed(self, event: RelationChangedEvent):
        ...
        self.log.debug(
            f"istio_gateway_info_receiver.py ~ gateway relation databag {rel_data}"
        )
        ...
        self._stored.gateway_info = {"gateway_name": rel_data.get("gateway_name"), "gateway_namespace": rel_data.get("gateway_namespace")}
